                    ...
                    loading ? (
                        ...
                        loadingList.map((product, index) => {
                            return (
                                ...
                                <div className='bg-white flex h-36 w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px]' key={index}>

                                    <div className='h-full bg-slate-200 min-w-[120px] w-[120px] md:min-w-[145px] p-2 animate-pulse'>

                                    </div>
                                    <div className='p-4 grid w-full gap-2'>
                                        <h1 className='font-medium text-black text-base md:text-lg text-ellipsis line-clamp-1 p-1 bg-slate-200 animate-pulse rounded-full'></h1>
                                        ...
                                        <button className=' mt-1 text-white p-1 px-3 py-0.5 text-sm rounded-full w-full bg-slate-200 animate-pulse '></button>
                                    </div>
                        ...
                        data.map((product, index) => {
                            return (
                                ...
                                <Link to={'product/' + product._id} className='bg-white flex h-36 w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px]' key={index}>

                                    <div className='h-full bg-slate-200 min-w-[120px] w-[120px] md:min-w-[145px] p-2'>
                                        <img src={product?.productImage[0]} alt="" className='object-scale-down h-full hover:scale-110 translate-all' />
                                    </div>
